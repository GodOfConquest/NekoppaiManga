    ...
    <div id="chapterInfoDiv" style="display:none">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-8">
          ...
          <strong><?php echo T('Image Uploader (Multiple select available)') ?></strong> <?php echo Form::input('uploaderInput', R('uploaderInput'), array("type"=>"file", "data-href"=>URL('admin/base64'), "data-dir"=>"upload/manga/".$thisManga['slug']."/", "id"=>"inputUploader", "class"=>"form-control ", "multiple")) ?>
