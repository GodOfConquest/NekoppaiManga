<?php 
	...
	function latest_manga($a){
		...
		foreach( $mangas as &$manga ){
			$return .= '<tr>
			                  	<td style="background-image:url(\''.URL($manga['cover']).'\');width:100px;height:100%;background-size: 100px; background-position:50% 30%; cursor: hand; cursor: pointer;" onclick="window.location = \''.URL(event('print_manga_url', $manga)).'\';"></td>
		...
		<div class="panel panel-primary">
          ...
          <div class="panel-body">
			<ul class="clrfix">
				...
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'action')) .'">Action</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'adult')) .'">Adult</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'adventure')) .'">Adventure</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'comedy')) .'">Comedy</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'doujinshi')) .'">Doujinshi</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'drama')) .'">Drama</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'ecchi')) .'">Ecchi</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'fantasy')) .'">Fantasy</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'gender-bender')) .'">Gender Bender</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'harem')) .'">Harem</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'historical')) .'">Historical</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'horror')) .'">Horror</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'josei')) .'">Josei</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'martial-arts')) .'">Martial Arts</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'mature')) .'">Mature</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'mecha')) .'">Mecha</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'mystery')) .'">Mystery</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'one-shot')) .'">One Shot</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'psychological')) .'">Psychological</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'romance')) .'">Romance</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'school-life')) .'">School Life</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'sci-fi')) .'">Sci-fi</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'seinen')) .'">Seinen</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'shoujo')) .'">Shoujo</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'shoujo-ai')) .'">Shoujo Ai</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'shounen')) .'">Shounen</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'shounen-ai')) .'">Shounen Ai</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'slice-of-life')) .'">Slice of Life</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'smut')) .'">Smut</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'sports')) .'">Sports</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'supernatural')) .'">Supernatural</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'tragedy')) .'">Tragedy</a></li>
				<li><a  href="'.url_param( URL(T('directory-slug', 'directory')), array('genre'=>'webtoons')) .'">Webtoons</a></li>
